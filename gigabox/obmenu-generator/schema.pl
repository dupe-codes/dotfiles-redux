...
our $SCHEMA = [
    ...
    {sep   => undef},
    {item => ["$ENV{HOME}/.config/openbox/scripts/toggle-breaktimer.sh", "Toggle Breaktimer", "$ENV{HOME}/.icons/Gladient/eyecandy.artistic.png"]},
    {item => ["$ENV{HOME}/.config/openbox/scripts/toggle-redshift.sh", "Toggle Redshift", "$ENV{HOME}/.icons/Gladient/eyecandy.artistic.png"]},
